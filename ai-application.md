...
description: 面向分析场景的应用与 Agent
---

<a class="back-link" href="{{ '/' | relative_url }}">← 返回作品目录</a>

<ul class="work-list">
  <li class="work-card">
    <h3>AB_test_flow — A/B 实验设计与分析工具</h3>
    <p>面向数据分析场景的 A/B 测试框架：以「订单转化率提升需求」为案例，演示核心指标与护栏指标的设计，提供样本量计算功能，采用账号级随机、A/B/C 对照与保留组，智能设计实验周期。</p>
